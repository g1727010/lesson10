Shader "Custom/NoiseShader" {
	...
	SubShader {
		...
		float Noise(float2 st)
		{
			...
			float2 v00 = random2(p + fixed2(0.0, 0.0));
			float2 v10 = random2(p + fixed2(1.0, 0.0));
			float2 v01 = random2(p + fixed2(0.0, 1.0));
			float2 v11 = random2(p + fixed2(1.0, 1.0));
